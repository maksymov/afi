...
- [3. ЧТО УМЕЕТ AFI](#3-ЧТО-УМЕЕТ-afi)
    ...
    - [3.2. Звания и Награды](#32-Звания-и-Награды)
        ...
        - [3.2.5. Статистика наград](#325-Статистика-наград)
...
#### 3.2.3. Присвоение звания и разжалование
...
#### 3.2.4. Создание награды

Создание награды будет выполняться командой:

`!добавить-награду-в-базу-данных [значёк] (название) <описание>`

Например:

`!добавить-награду-в-базу-данных [☔️] (ПВО) <забрать 3 воздуха с наземки>`

После этого награда сохранится в базе данных полка и её можно будет вручать игрокам.

#### 3.2.5. Удаление награды
...
#### 3.2.6. Вручение и возврат наград
...
в круглых скобках - начальная дата, а в квадратных - конечная. Если команда дана неверно - бот дасть подсказку.
