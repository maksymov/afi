...
`!добавить-звание-в-базу-данных [значёк￼￼￼￼￼️￼￼￼￼￼] (название) <описание>`

Например:

`!добавить-звание-в-базу-данных [💯￼￼￼￼￼️￼￼￼￼￼] (МАРШАЛ) <получают игроки с сотым уровнем в игре>`
